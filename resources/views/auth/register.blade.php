...
<div class="register-box">
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="{{url('storeReg')}}" method="post">
        @csrf
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control @error('cnf_pass') is-invalid @enderror" name="cnf_pass" placeholder="Retype password">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
